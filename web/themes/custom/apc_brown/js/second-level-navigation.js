...
((Drupal) => {
  const { isDesktopNav } = Drupal.apcBrown;
  ...
  Drupal.apcBrown.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.apcBrown.isDesktopNav()) return;
  ...
  Drupal.apcBrown.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.apcBrown.areAnySubNavsOpen = areAnySubNavsOpen;
